...
urlpatterns = [
    path('admin-panel/report/monitor/exam/<exam_id>', views.monitor_exam, name='Monitor Realtime'),
    path('admin-panel/report/test', views.test_report, name='Post Add'),
    path('admin-panel/report/exam/pdf/<exam_id>', views.pdf_exam, name='Post Add'),
